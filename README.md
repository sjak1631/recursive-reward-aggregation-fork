...
```sh
/workspace/RRA/portfolio_cvar/run_portfolio.sh --seed 4 --bins 201 --train_objective cvar
```
...
tmux attach -t PPO_Portfolio_cvar_ours_multi_env_seed4_cvar_bins201
```
...
- Outputs are written under `/workspace/RRA/portfolio_cvar/workspace/`.
- The experiment expects data in `portfolio_cvar/preproc_data/`.